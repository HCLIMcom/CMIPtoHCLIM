...
# -----------------------
 ...
 #run_in=(CNRM-ESM2-1_ssp370_r1i1p1f2_gr)
 #run_in=(ENSMEAN_historical_r1i1p1f1_gr90N)
 #run_in=(EC-Earth3-Veg_historical_r1i1p1f1_gr)
 #run_in=(EC-Earth3-Veg_historical_r2i1p1f1_gr)
 #run_in=(CMCC-CM2-SR5_historical_r1i1p1f1_gn)
  
 #run_in=(MPI-ESM1-2-HR_historical_r1i1p1f1_gn)
 #run_in=(MPI-ESM1-2-HR_ssp126_r1i1p1f1_gn)
 #run_in=(MPI-ESM1-2-HR_ssp370_r1i1p1f1_gn)
 ####run_in=(MPI-ESM1-2-HR_ssp585_r1i1p1f1_gn) not downloaded
 
 #run_in=(EC-Earth3-Veg_ssp126_r1i1p1f1_gr)
 #run_in=(EC-Earth3-Veg_ssp370_r1i1p1f1_gr)
 #run_in=(EC-Earth3-Veg_ssp585_r1i1p1f1_gr)
...
# --- read simulation info (simulation id) ---
 ...
 case $gcm_name in
  ...
  #MPI-ESM1-2-HR) gcm_ins='MPI-M';;
  MPI-ESM1-2-HR) gcm_ins='DKRZ';;
 esac
...
#------------------------------
 ...
 #path_in=$path_ref_in"/"$gcm_act"/"$gcm_ins"/"$gcm_name"/"$gcm_exp"/"$gcm_mem"/"$table_in"/od550aer/"$gcm_grid"/1/"  
 ...
 case $gcm_exp in
  historical)   file_rat=$path_rat_in${var_in[$var]}"rt_AERmon_ENSMEAN_historical_r1i1p1f1_gr90N_195001-201412.nc";;
  ssp* ) file_rat=$path_rat_in${var_in[$var]}"rt_AERmon_ENSMEAN_"$gcm_exp"_r1i1p1f1_gr90N_201501-210012.nc";;
 esac
...
mask_file_in=$path_in$"od550aer"_$table_in'_'$gcm_name'_'$gcm_exp'_'$gcm_mem'_'$gcm_grid'_'*'.nc'
