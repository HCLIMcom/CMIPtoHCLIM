 ...
 # --- temporary file names ---
  ...
  ########### PROCESSING TIME STEPS ####################
   ...
   # ---    orography   ---
    ...
    file_orog_tmp0=$path_out'tmp0_orog_'$yy'_'$ss'.nc'
    [ -f $file_orog_tmp ] && rm $file_orog_tmp
    [ -f $file_orog_tmp0 ] && rm $file_orog_tmp0
   ...
   # ---  land sea mask   ---
    ...
    file_sftlf_tmp0=$path_out'tmp0_sftlf_'$yy'_'$ss'.nc' 
    [ -f $file_sftlf_tmp ] && rm $file_sftlf_tmp
    [ -f $file_sftlf_tmp0 ] && rm $file_sftlf_tmp0

    ncap2 -h -O -s 'sftlf(:, :)=1.;' $file_sftlf_in $file_sftlf_tmp0 
    $cdo -L -f grb -divc,100 -setparam,172.128 -settunits,hour -setreftime,$aaa_time_ref -settime,$aaa_time -setdate,$aaa_date $file_sftlf_tmp0 $file_sftlf_tmp
