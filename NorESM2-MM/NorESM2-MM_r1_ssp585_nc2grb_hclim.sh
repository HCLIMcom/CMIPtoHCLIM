...
# ---     EXPERIMENT       ---
#-----------------------------
 grb_name='NorESM2-MM_r1i1p1f1_ssp585'
...
#------------------------------
 path_ref_in='/home/rossby/boundary/CMIP6/NorESM2-MM/r1i1p1f1/ssp585/nc/'
 
 #path_out='/nobackup/rossby24/users/sm_grini/Data/CMIP6/LBC/NorESM2-MM/grb/2041-2055/'
 #path_out='/nobackup/rossby24/users/sm_grini/Data/CMIP6/LBC/NorESM2-MM/grb/2056-2072/'
 
 #path_out='/nobackup/rossby24/users/sm_grini/Data/TEMP/20230421_noresm_lbc/2073-2080/'
 #path_out='/nobackup/rossby24/users/sm_grini/Data/TEMP/20230421_noresm_lbc/2081-2090/'
 #path_out='/nobackup/rossby24/users/sm_grini/Data/TEMP/20230421_noresm_lbc/2091-2100/'
 path_out='/nobackup/rossby24/users/sm_grini/Data/TEMP/20230421_noresm_lbc/2100/'


 #path_out='/home/rossby/boundary/CMIP6/NorESM2-MM/r1i1p1f1/ssp585/grb/'
 ...
 for ((yy=fy;yy<=ly;yy++)); do   # year loop
  ...
  # ---------------------------------
   for ((nn=1;nn<=num_file_ta;nn++)); do
    ...
    #if [ $yy -ge ${fy_file_ta[$nn]} -a $yy -le ${ly_file_ta[$nn]} ]; then    # 2015-2020
    if [ $yy -ge ${fy_file_ta[$nn]} -a $yy -lt ${ly_file_ta[$nn]} ]; then    # 2021 - ...
  ...
  # --- get one year ($yy)  ----
    #f_date_ta=$yy'-01-01T01:00:00'  #hist
    #l_date_ta=$yy'-12-31T23:00:00'  #hist
    
    #f_date_ta=$yy'-01-01T05:00:00'
    #l_date_ta=$((yy+1))'-01-01T01:00:00'
    
    f_date_ta=$yy'-12-31T01:00:00'  #hist
    #l_date_ta=$yy'-12-31T23:00:00'  #hist
    l_date_ta=$((yy+1))'-01-01T01:00:00'
  ...
  # ---------------------------------
   ...
   case $yy in
      2100) echo ... 2100 tos ...
            $cdo selyear,$((yy-1)),$yy $file_tos_tmp0 $file_tos_tmp1  
  ...
  # ---------------
    ...
    case $yy in
      2100) echo ... 2100 tos ...
            $cdo selyear,$((yy-1)),$yy $file_sic_tmp0 $file_sic_tmp1  
