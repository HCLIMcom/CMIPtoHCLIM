...
#######################################################################
####                                                               ####
####    CESM2 output (nc) to HCLIM input files (grb)       ####
####                            CMIP6                              #### 
####                                                               ####  
#######################################################################
...
#------------------------------
 path_ref_in='/nobackup/rossby24/proj/rossby/boundary/CMIP6/CESM2/r11i1p1f1/historical/nc/'
 path_out='/nobackup/rossby24/proj/rossby/boundary/CMIP6/CESM2/r11i1p1f1/historical/grb/'
...
# -----------------
 cdo='cdo -s'
 file_grid='CESM2_288x192.grid'
 file_weight_a2o='CESM2_remapdis_weights_atmos2ocean.nc'
 file_grid_ocean='CESM2_ocean_384x384.grid'
 #file_zaxis=./zaxis/CESM2_zaxis_grb_reverse
 ...
 for ((yy=fy;yy<=ly;yy++)); do   # year loop
  ...
  # --- ua ----
   ...
   #$cdo -L -invertlev -seldate,$f_date_ta,$l_date_ta ${file_ua[$((nn))]} $file_ua_yr
    $cdo -L -seldate,$f_date_ta,$l_date_ta ${file_ua[$((nn))]} $file_ua_yr
