...
# ---     EXPERIMENT       ---
#-----------------------------
 grb_name='CMCC-CM2-SR5_r1i1p1f1_ssp585'
...
#------------------------------
 path_ref_in='/home/rossby/boundary/CMIP6/CMCC-CM2-SR5/r1i1p1f1/ssp585/nc/'

 #path_out='/nobackup/rossby24/users/sm_grini/Data/CMIP6/LBC/CMCC-CM2-SR5/r1i1p1f1/ssp585/grb/2016-2020/'
 #path_out='/nobackup/rossby24/users/sm_grini/Data/CMIP6/LBC/CMCC-CM2-SR5/r1i1p1f1/ssp585/grb/2021-2030/'
 #path_out='/nobackup/rossby24/users/sm_grini/Data/CMIP6/LBC/CMCC-CM2-SR5/r1i1p1f1/ssp585/grb/2031-2046/'
 #path_out='/nobackup/rossby24/users/sm_grini/Data/CMIP6/LBC/CMCC-CM2-SR5/r1i1p1f1/ssp585/grb/2047-2072/'
  path_out='/nobackup/rossby24/users/sm_grini/Data/CMIP6/LBC/CMCC-CM2-SR5/r1i1p1f1/ssp585/grb/2071-2071/'
...
# --- number of time step (ta file) ---
 ...
 for ((ss=1;ss<=$((num_ta));ss++)); do   # time step loop
   #for ((ss=1;ss<=1;ss++)); do   # time step loop
    #for ((ss=1;ss<=135;ss++)); do   # time step loop
